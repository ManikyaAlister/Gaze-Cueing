...
#Load data
P = read_csv("Data/dataset1a/raw/Study1RawData .csv") # data set 1b is the same raw data as 1a
...
# Wrangle and rename variables into a format that DDM script will recognise
