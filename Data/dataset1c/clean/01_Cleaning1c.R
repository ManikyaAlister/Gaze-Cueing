...
trals.rm = length(P$Time) - original.length


save(P, file = "Data/dataset1c/clean/all-participants.RData")
...
for(i in 1:n) {
  ...
  data =  filter(P, ID == i)
  assign(PID, data)
  save(data, file = paste("Data/dataset1c/clean/P",i,".Rdata",sep=""))
}
