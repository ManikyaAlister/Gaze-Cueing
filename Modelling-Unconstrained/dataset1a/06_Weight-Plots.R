...
for (p in 1:S) { 
  load(paste("Modelling-Unconstrained/dataset1a/07_Outputs/P",p,"_v-z_Model.RData", sep = ""))
  AIC_v_z = rbind(AIC, AIC_v_z)
  BIC_v_z = rbind(BIC, BIC_v_z)
  
}

#save(AIC_C, file = "Data/dataset1a/derived-unconstrained/AIC_C.RData") #To save for each individual model if wanted (copy for each model)
#save(BIC_C, file = "Data/dataset1a/derived-unconstrained/BIC_C.RData")
...
for (p in 1:S) { 
  load(paste("Modelling-Unconstrained/dataset1a/07_Outputs/P",p,"Simple_Model.RData", sep = ""))
...
for (p in 1:S) { 
  load(paste("Modelling-Unconstrained/dataset1a/07_Outputs/P",p,"_v_Model.RData", sep = ""))
...
for (p in 1:S) { #Loop in each data set
  load(paste("Modelling-Unconstrained/dataset1a/07_Outputs/P",p,"_z_Model.RData", sep = ""))
...
for (p in 1:S) { 
  load(paste("Modelling-Unconstrained/dataset1a/07_Outputs/P",p,"_t0_Model.RData", sep = ""))
...
#Loop in each data set and combine to create a vector of AIC and BIC respectively for each participant
for (p in 1:S) { #Loop in each data set
  load(paste("Modelling-Unconstrained/dataset1a/07_outputs/P",p,"_z-t0_Model.RData", sep = ""))
...
#Loop in each data set and combine to create a vector of AIC and BIC respectively for each participant
for (p in 1:S) { #Loop in each data set
  load(paste("Modelling-Unconstrained/dataset1a/07_Outputs/P",p,"_v-t0_Model.RData", sep = ""))
...
#Loop in each data set and combine to create a vector of AIC and BIC respectively for each participant
for (p in 1:S) { #Loop in each data set
  load(paste("Modelling-Unconstrained/dataset1a/07_Outputs/P",p,"_all-params_Model.RData", sep = ""))
...
save(AIC_comp, file = "Data/dataset1a/derived-unconstrained/AICs.Rdata")
save(BIC_comp, file = "Data/dataset1a/derived-unconstrained/BICs.Rdata")

###########################
### Model Probabilities ##
###########################

load("Data/dataset1a/derived-unconstrained/BICs.Rdata")
load("Data/dataset1a/derived-unconstrained/AICs.Rdata")
...
save(participants_alt, file = "Data/dataset1a/derived-unconstrained/participants_alt.Rdata")
save(participants_null, file = "Data/dataset1a/derived-unconstrained/participants_null.Rdata")

#save(BICweights, file = "Data/dataset1a/derived-unconstrained/BF-Weights.RData")
#save(BIC_comp, file = "Data/dataset1a/derived-unconstrained/BICs.RData")
...
png("Modelling-Unconstrained/dataset1a/08_Plots/weighted-prob-BIC.png")
plot(x=100,y=100,xlim=c(0,S),ylim=c(0,1),xlab="",ylab="",main="Unc. BIC",xaxt="n",yaxt="n")
...
#save(AICweights, file = "Data/dataset1a/derived-unconstrained/BF-Weights.RData")
#save(BIC_comp, file = "Data/dataset1a/derived-unconstrained/BICs.RData")
...
S = 41 #n participants
png("Modelling-Unconstrained/dataset1a/08_Plots/weighted-prob-AIC.png")
plot(x=100,y=100,xlim=c(0,S),ylim=c(0,1),xlab="",ylab="",main="Unc. AIC",xaxt="n",yaxt="n")
...
png("Modelling-Unconstrained/dataset1a/08_Plots/inclusion-prob-BIC-z.png")  
  plot(x=100,y=100,xlim=c(0,S),ylim=c(0,1),xlab="",ylab="",main="Unc. z Inclusion Probability BIC",xaxt="n",yaxt="n")
for (i in 1:S) {
  use.i=i
  sumThing=0
...
png("Modelling-Unconstrained/dataset1a/08_Plots/inclusion-prob-BIC-v.png")    
  plot(x=100,y=100,xlim=c(0,S),ylim=c(0,1),xlab="",ylab="",main="Unc. v Inclusion Probability BIC",xaxt="n",yaxt="n")
for (i in 1:S) {
  use.i=i
  sumThing=0
...
png("Modelling-Unconstrained/dataset1a/08_Plots/inclusion-prob-BIC-t0.png")  
plot(x=100,y=100,xlim=c(0,S),ylim=c(0,1),xlab="",ylab="",main="Unc. t0 Inclusion Probability BIC",xaxt="n",yaxt="n")
for (i in 1:S) {
  use.i=i
  sumThing=0
  col=hcl(h=330,c=100,l=0)
...
#To get a inclusion probability for z, we just add the models that have z and don’t have z:
png("Modelling-Unconstrained/dataset1a/08_Plots/inclusion-prob-AIC-z.png")  
plot(x=100,y=100,xlim=c(0,S),ylim=c(0,1),xlab="",ylab="",main="Unc. z Inclusion Probability AIC",xaxt="n",yaxt="n")
for (i in 1:S) {
  use.i=i
  sumThing=0
  col=hcl(h=330,c=100,l=0)
...
##### v ######
#And same principle for v:
png("Modelling-Unconstrained/dataset1a/08_Plots/inclusion-prob-AIC-v.png")  
plot(x=100,y=100,xlim=c(0,S),ylim=c(0,1),xlab="",ylab="",main="Unc. v Inclusion Probability AIC",xaxt="n",yaxt="n")
for (i in 1:S) {
  use.i=i
  sumThing=0
  col=hcl(h=330,c=100,l=1)
...
#### t0 #####
#And same principle for t0:
png("Modelling-Unconstrained/dataset1a/08_Plots/inclusion-prob-AIC-t0.png")  
plot(x=100,y=100,xlim=c(0,S),ylim=c(0,1),xlab="",ylab="",main="Unc. t0 Inclusion Probability AIC",xaxt="n",yaxt="n")
for (i in 1:S) {
  use.i=i
  sumThing=0
  col=hcl(h=330,c=100,l=0)
...
save(mean_AICweights, file = "Data/dataset1a/derived-unconstrained/mean_AICweights.Rdata")
...
save(best_AIC, file = "Data/dataset1a/derived-unconstrained/best_AIC.Rdata")

## BIC ##

mean_BICweights = apply(BICweights,2,mean) ##Check mean BIC weight of each model averaged across participants
save(mean_BICweights, file = "Data/dataset1a/derived-unconstrained/mean_BICweights.Rdata")
#v_z            none           v             z          z_t0    v_t0      all_params      t0 
...
save(best_BIC, file = "Data/dataset1a/derived-unconstrained/best_BIC.Rdata")
