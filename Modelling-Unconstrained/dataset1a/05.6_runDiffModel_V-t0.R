...
for (useSub in 1:nSub) {
  ...
  savefile=paste("Modelling-Unconstrained/dataset1a/07_Outputs/P",useSub,"_v-t0_Model.Rdata",sep="")
...
for(useSub in 1:nSub) {
  ...
  load(paste("Modelling-Unconstrained/dataset1a/07_Outputs/P",useSub,"_v-t0_Model.Rdata", sep = "")) #Loads through the datasets of each participant in nSub
  ...
  save(sim, file = paste("Data/dataset1a/Model-Predictions-Unconstrained/P",useSub,"_v-t0.Rdata", sep = ""))
