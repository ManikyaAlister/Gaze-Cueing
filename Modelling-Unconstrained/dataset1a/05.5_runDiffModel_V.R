...
for (useSub in 1:nSub) {
  ...
  savefile=paste("Modelling-Unconstrained/dataset1a/07_Outputs/P",useSub,"_v_Model.Rdata",sep="")
...
for(useSub in 1:nSub) {
  ...
  load(paste("Modelling-Unconstrained/dataset1a/07_Outputs/P",useSub,"_v_Model.Rdata", sep = "")) #Loads through the datasets of each participant in nSub
  ...
  save(sim, file = paste("Data/dataset1a/model-predictions-unconstrained/P",useSub,"_v.Rdata", sep = ""))
