### Quantile Model Fits on Null Model Data ###
...
load("data/dataset1a/derived-unconstrained/participants_null.Rdata")
...
ggsave("Modelling-Unconstrained/dataset1a/08_Plots/quantiles-v-z-null.png", plot = quantiles_v_z)
...
ggsave("Modelling-Unconstrained/dataset1a/08_Plots/quantiles-z-null.png", plot = quantiles_z)  
...
ggsave("Modelling-Unconstrained/dataset1a/08_Plots/quantiles-v-null.png", plot = quantiles_v)
...
quantiles_t0 = ggplot()+
  ...
  labs(title = "Unc. t0 on null model data")+
  theme_apa()
quantiles_t0 # view plot
ggsave(filename = paste("Modelling-Unconstrained/dataset1a/08_Plots/quantiles-t0-null.png", sep = ""), plot = quantiles_t0)
ggsave("Modelling-Unconstrained/dataset1a/08_Plots/quantiles-t0.png")
...
ggsave("Modelling-Unconstrained/dataset1a/08_Plots/quantiles-v-t0-null.png", plot = quantiles_v_t0)
...
ggsave(filename = paste("Modelling-Unconstrained/dataset1a/08_Plots/quantiles_z-t0-null.png", sep = ""), plot = quantiles_z_t0)
...
for (useSub in 1:nSub) {
  ...
  load(paste("Data/dataset1a/model-predictions-unconstrained/P",useSub,"_complex.RData",sep=""))
...
ggsave("Modelling-Unconstrained/dataset1a/08_Plots/quantiles-complex-null.png", plot = quantiles_complex)
...
ggsave("Modelling-Unconstrained/dataset1a/08_Plots/quantiles-simple-null.png", plot = quantiles_simple)
#Separated across conditions
...
ggplot()+
  ...
  geom_point(aes(x = q.mean.2.1_s, y = qs*p.mean.1_s),shape = 1)+
  geom_line(aes(x = q.mean.2.1_s, y = qs*p.mean.1_s))+
  labs(title = "Unc. Simple", subtitle =  "Congruent")
  theme_apa()
