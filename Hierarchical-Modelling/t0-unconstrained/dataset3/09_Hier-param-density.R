...
pdf("Hierarchical-Modelling/t0-unconstrained/dataset3/08_Plots/z.pdf",width=4,height=4)
...
pdf("Hierarchical-Modelling/t0-unconstrained/dataset3/08_Plots/t0.pdf",width=4,height=4)
...
pdf("Hierarchical-Modelling/t0-unconstrained/dataset3/08_Plots/v.pdf",width=4,height=4)
