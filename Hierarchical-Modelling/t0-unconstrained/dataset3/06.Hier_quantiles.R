...
load("Data/dataset3/hier-model-predictions/t0-unconstrained/complex.RData")
...
pdf("Hierarchical-Modelling/t0-unconstrained/dataset3/08_plots/quantiles.pdf",width=7,height=7)

plot(q.mean.2.1,qs*p.mean.1.1,pch=16, cex = 0.9, cex.lab = .9, xlab = "", ylab = "", main = "Hier. Complex Model", xlim = c(.3,.8)) 
