...
load("Hierarchical-Modelling/z-unconstrained/dataset1b/07_Output/Hier_Complex_Model.Rdata") #Load parameters
...
save(simData, file = "Data/dataset1b/Hier-Model-Predictions/z-unconstrained/complex.RData") # Naming complex even though it's not technically the full complex model so that less code needs to be changed
