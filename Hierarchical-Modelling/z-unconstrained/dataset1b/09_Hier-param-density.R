...
pdf("Hierarchical-Modelling/z-unconstrained/dataset1b/08_Plots/z.pdf",width=4,height=4)
...
pdf("Hierarchical-Modelling/z-unconstrained/dataset1b/08_Plots/t0.pdf",width=4,height=4)
...
pdf("Hierarchical-Modelling/z-unconstrained/dataset1b/08_Plots/v.pdf",width=4,height=4)
