...
source("Hierarchical-Modelling/dataset1c/01_Hier_Megabackground.R")
...
savefile=paste("Hierarchical-Modelling/dataset1c/07_Output/Hier_Complex_Model.Rdata",sep="")




source("Hierarchical-Modelling/dataset1c/02_Hier_Background.R")
source("Hierarchical-Modelling/dataset1c/03_Hier_iterative.R")
