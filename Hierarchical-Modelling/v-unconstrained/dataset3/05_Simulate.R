...
load("Hierarchical-Modelling/v-unconstrained/dataset3/07_Output/Hier_Complex_Model.Rdata") #Load parameters
...
save(simData, file = "Data/dataset3/Hier-Model-Predictions/v-unconstrained/complex.RData") # Naming complex even though it's not technically the full complex model so that less code needs to be changed
