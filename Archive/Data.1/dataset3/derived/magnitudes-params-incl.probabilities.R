...
save(BIC_incl_prob, file = "Data/dataset3/derived/BIC_inclusion_probabilities.RData")
...
for (i in 1:S) {
  load(paste("Modelling/dataset3/07_Outputs/P",i,"_complex_Model.RData", sep = "")) 
...
table = cbind(magnitude, params.diff, prob_z, prob_v, prob_t0)
save(table, file = "Data/dataset3/derived/magnitudes-params-incl.probs.RData")
