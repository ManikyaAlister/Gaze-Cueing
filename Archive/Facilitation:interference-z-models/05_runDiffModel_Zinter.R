...
for (useSub in 1:nSub) {
  ...
  savefile=paste("Fits_zinter/P",useSub,"zinter_Model.Rdata",sep="")
...
for(useSub in 1:nSub) {
  ...
  load(paste("Fits_zinter/P",useSub,"zinter_Model.Rdata", sep = "")) #Loads through the datasets of each participant in nSub
  ...
  save(sim, file = paste("Data/Model-Predictions/P",useSub,"_zinter.Rdata", sep = ""))
