...
for (p in 1:n) { #Loop in each data set
  ...
  names(tmp) = c("a", "t0", "v.-0.5", "v.0.5", "zFacil")
...
save(allGenParams, file = "All_Fits/zfacil_Generated_Paramaters.RData")
save(allMeanTheta, file = "All_Fits/zfacil_Estimated_Paramaters.RData")
