...
#Loop in each data set and combine to create a vector of AIC and BIC respectively for each participant
for (p in 1:S) { #Loop in each data set
  load(paste("Modelling/dataset1c/07_Outputs/P",p,"_complex_Model.RData", sep = ""))
...
save(BICweights, file = "Data/dataset1c/derived/BIC-Weights.RData")
save(BIC_comp, file = "Data/dataset1c/derived/BICs.RData")
...
save(AICweights, file = "Data/dataset1c/derived/AIC-Weights.RData")
save(AIC_comp, file = "Data/dataset1c/derived/AICs.RData")
