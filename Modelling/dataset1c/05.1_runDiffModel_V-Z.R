...
source("Modelling/dataset1c/02_megaBackground.R")
...
for (useSub in 1:nSub) {
  ...
  savefile=paste("Modelling/dataset1c/07_Outputs/P",useSub,"_v-z_Model.Rdata",sep="")
  
  source("Modelling/dataset1c/03_background.R")
  source("Modelling/dataset1c/04_runIterativeProcess.R")
...
for(useSub in 1:nSub) {
  ...
  load(paste("Modelling/dataset1c/07_Outputs/P",useSub,"_v-z_Model.Rdata", sep = "")) #Loads through the datasets of each participant in nSub
  ...
  save(sim, file = paste("Data/dataset1c/Model-Predictions/P",useSub,"_v-z.Rdata", sep = ""))
