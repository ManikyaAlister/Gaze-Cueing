...
for (p in 1:S) { 
  load(paste("Modelling/dataset2/07_Outputs/P",p,"_v-z_Model.RData", sep = ""))
  AIC_v_z = rbind(AIC, AIC_v_z)
  BIC_v_z = rbind(BIC, BIC_v_z)
  
}

#save(AIC_C, file = "Data/dataset2/derived/AIC_C.RData") #To save for each individual model if wanted (copy for each model)
#save(BIC_C, file = "Data/dataset2/derived/BIC_C.RData")
...
for (p in 1:S) { 
  load(paste("Modelling/dataset2/07_Outputs/P",p,"Simple_Model.RData", sep = ""))
...
for (p in 1:S) { 
  load(paste("Modelling/dataset2/07_Outputs/P",p,"_v_Model.Rdata", sep = "")) #Not working!? 
...
for (p in 1:S) { #Loop in each data set
  load(paste("Modelling/dataset2/07_Outputs/P",p,"_z_Model.RData", sep = ""))
...
for (p in 1:S) { 
  load(paste("Modelling/dataset2/07_Outputs/P",p,"_t0_Model.RData", sep = ""))
...
#Loop in each data set and combine to create a vector of AIC and BIC respectively for each participant
for (p in 1:S) { #Loop in each data set
  load(paste("Modelling/dataset2/07_outputs/P",p,"_z-t0_Model.RData", sep = ""))
...
#Loop in each data set and combine to create a vector of AIC and BIC respectively for each participant
for (p in 1:S) { #Loop in each data set
  load(paste("Modelling/dataset2/07_Outputs/P",p,"_v-t0_Model.RData", sep = ""))
...
#Loop in each data set and combine to create a vector of AIC and BIC respectively for each participant
for (p in 1:S) { #Loop in each data set
  load(paste("Modelling/dataset2/07_Outputs/P",p,"_complex_Model.RData", sep = ""))
...
load("Data/dataset2/derived/BICs.Rdata")
load("Data/dataset2/derived/AICs.Rdata")
...
save(participants_alt, file = "Data/dataset2/derived/participants_alt.Rdata")
save(participants_null, file = "Data/dataset2/derived/participants_null.Rdata")

save(BICweights, file = "Data/dataset2/derived/BIC-Weights.RData")
save(BIC_comp, file = "Data/dataset2/derived/BICs.RData")
...
png("Modelling/dataset2/08_Plots/weighted-prob-BIC.png")
...
S = 50 #n participants
png("Modelling/dataset2/08_Plots/weighted-prob-AIC.png")
...
png("Modelling/dataset2/08_Plots/inclusion-prob-BIC-z.png")  
...
png("Modelling/dataset2/08_Plots/inclusion-prob-BIC-v.png")    
...
png("Modelling/dataset2/08_Plots/inclusion-prob-BIC-t0.png")  
...
#To get a inclusion probability for z, we just add the models that have z and don’t have z:
png("Modelling/dataset2/08_Plots/inclusion-prob-AIC-z.png")  
...
##### v ######
#And same principle for v:
png("Modelling/dataset2/08_Plots/inclusion-prob-AIC-v.png")  
...
#### t0 #####
#And same principle for t0:
png("Modelling/dataset2/08_Plots/inclusion-prob-AIC-t0.png")  
