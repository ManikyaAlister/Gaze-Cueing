...
for (useSub in 1:nSub) {
  ...
  savefile=here(paste("Modelling/dataset2/07_Outputs/P",useSub,"_z-t0_Model.Rdata",sep=""))
...
for(useSub in 1:nSub) {
  ...
  load(here(paste("Modelling/dataset2/07_Outputs/P",useSub,"_z-t0_Model.Rdata", sep = ""))) #Loads through the datasets of each participant in nSub
  ...
  save(sim, file = here(paste("Data/dataset2/Model-Predictions/P",useSub,"_z-t0.Rdata", sep = "")))
