...
for (useSub in 1:nSub) {
  ...
  savefile=paste("Modelling/dataset2/07_Outputs/P",useSub,"_v_Model.Rdata",sep="")
...
for(useSub in 1:nSub) {
  ...
  load(paste("Modelling/dataset2/07_Outputs/P",useSub,"_v_Model.Rdata", sep = "")) #Loads through the datasets of each participant in nSub
  ...
  save(sim, file = paste("Data/dataset2/Model-Predictions/P",useSub,"_v.Rdata", sep = ""))
