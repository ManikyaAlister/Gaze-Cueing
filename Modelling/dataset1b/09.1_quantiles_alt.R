...
load("data/dataset1b/derived/participants_alt.Rdata")
...
all.data = all.data[participants_alt]
...
ggsave("Modelling/dataset1b/08_Plots/quantiles-v-z-alt.png", plot = quantiles_v_z)
...
ggsave("Modelling/dataset1b/08_Plots/quantiles-z-alt.png", plot = quantiles_z)  
...
ggsave("Modelling/dataset1b/08_Plots/quantiles-v-alt.png", plot = quantiles_v)
...
simData_t0_alt = simData_t0[participants_alt]
simData_t0 = simData_t0[participants_alt]
...
ggsave("Modelling/dataset1b/08_Plots/quantiles-t0-alt.png", plot = quantiles_t0)
...
ggsave("Modelling/dataset1b/08_Plots/quantiles-v-t0-alt.png", plot = quantiles_v_t0)
...
ggsave("Modelling/dataset1b/08_Plots/quantiles_z-t0-alt.png", plot = quantiles_z_t0)
...
for (useSub in 1:nSub) {
  ...
  load(paste("Data/dataset1b/Model-Predictions/P",useSub,"_all-params.RData",sep=""))
...
ggsave("Modelling/dataset1b/08_Plots/quantiles-all-params-alt.png", plot = quantiles_all_params)
...
ggsave("Modelling/dataset1b/08_Plots/quantiles-simple-alt.png", plot = quantiles_simple)
#Separated across conditions
