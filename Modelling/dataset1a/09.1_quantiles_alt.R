...
load("data/dataset1a/derived/participants_alt.Rdata")
...
ggsave("Modelling/dataset1a/08_Plots/quantiles-v-z-alt.png", plot = quantiles_v_z)
...
ggsave("Modelling/dataset1a/08_Plots/quantiles-z-alt.png", plot = quantiles_z)  
...
ggsave("Modelling/dataset1a/08_Plots/quantiles-v-alt.png", plot = quantiles_v)
...
ggsave("Modelling/dataset1a/08_Plots/quantiles-t0-alt.png", plot = quantiles_t0)
...
ggsave("Modelling/dataset1a/08_Plots/quantiles-v-t0-alt.png", plot = quantiles_v_t0)
...
ggsave("Modelling/dataset1a/08_Plots/quantiles_z-t0-alt.png", plot = quantiles_z_t0)
...
ggsave("Modelling/dataset1a/08_Plots/quantiles-all-params-alt.png", plot = quantiles_all_params)
...
ggsave("Modelling/dataset1a/08_Plots/quantiles-simple-alt.png", plot = quantiles_simple)
#Separated across conditions
