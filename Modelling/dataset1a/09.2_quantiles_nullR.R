...
load("data/dataset1a/derived/participants_null.Rdata")
...
ggsave("Modelling/dataset1a/08_Plots/quantiles-v-z-null.png", plot = quantiles_v_z)
...
ggsave("Modelling/dataset1a/08_Plots/quantiles-z-null.png", plot = quantiles_z)  
...
ggsave("Modelling/dataset1a/08_Plots/quantiles-v-null.png", plot = quantiles_v)
...
ggsave(filename = paste("Modelling/dataset1a/08_Plots/quantiles-t0-null.png", sep = ""), plot = quantiles_t0)
ggsave("Modelling/dataset1a/08_Plots/quantiles-t0.png")
...
ggsave("Modelling/dataset1a/08_Plots/quantiles-v-t0-null.png", plot = quantiles_v_t0)
...
ggsave(filename = paste("Modelling/dataset1a/08_Plots/quantiles_z-t0-null.png", sep = ""), plot = quantiles_z_t0)
...
ggsave("Modelling/dataset1a/08_Plots/quantiles-all-params-null.png", plot = quantiles_all_params)
...
ggsave("Modelling/dataset1a/08_Plots/quantiles-simple-null.png", plot = quantiles_simple)
#Separated across conditions
