...
for (useSub in 1:nSub) {
  ...
  savefile=paste("Modelling/07_Outputs/DS",dataset,"_P",useSub,"_t0Model.Rdata",sep="")
...
for(useSub in 1:nSub) {
  ...
  load(paste("Modelling/07_Outputs/DS",dataset,"_P",useSub,"_t0Model.Rdata", sep = "")) #Loads through the datasets of each participant in nSub
  ...
  save(sim, file = paste("Data/Model-Predictions/DS",dataset,"_P",useSub,"_t0.Rdata", sep = ""))
