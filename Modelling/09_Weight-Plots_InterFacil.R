...
for (i in 1:S) {
  ...
  col=hcl(h=90,c=100,l=40) 
  rect(i-0.5,sumThing,i+0.5,sumThing+BFweights[use.i,"zinter"], border = col, col = col)
  sumThing=sumThing+BFweights[use.i,"zinter"]
...
legend("bottom", 
       legend = c("Complex", "Simple", "v", "z", "zinter"), 
       col = c(hcl(h=420,c=100,l=70),hcl(h=330,c=100,l=40), hcl(h=220,c=100,l=40), hcl(h=130,c=100,l=70), hcl(h=90,c=100,l=40) ),
       pch = 15,
       horiz = T,
       cex = .73,
       inset=c(0,.0))
...
for (i in 1:S) {
  ...
  col=hcl(h=330,c=100,l=40) #Purple
  rect(i-0.5,0,i+0.5,sumThing+AICweights[use.i,"none"], border = col, col = col)
