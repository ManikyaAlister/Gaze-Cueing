...
pdf("Manuscript-figures/Weighted-AIC-Exploritory.pdf",width=3*3+1,height=(4*3)+3)
...
load("Data/dataset3-SOA2/derived/AIC-Weights.RData")
...
load("Data/dataset3-SOA5/derived/AIC-Weights.RData")
# Plotting
...
load("Data/dataset3-ea/derived/AIC-Weights.RData")
# Plotting
for (i in 1:S) {
  use.i=i
  sumThing=0
...
plot(x=100,y=100,xlim=c(0,S),ylim=c(0,1),xlab="",ylab="Probability",main=,xaxt="n",yaxt="n")
load("Data/dataset3-eh/derived/AIC-Weights.RData")
# Plotting
...
load("Data/dataset3-en/derived/AIC-Weights.RData")
...
plot(x=100,y=100,xlim=c(0,S),ylim=c(0,1),xlab="",ylab="Probability",main=,xaxt="n",yaxt="n")
load("Data/dataset3-ef/derived/AIC-Weights.RData")
# Plotting
