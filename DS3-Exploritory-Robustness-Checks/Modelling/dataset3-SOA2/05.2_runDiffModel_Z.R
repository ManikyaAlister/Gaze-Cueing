...
for (useSub in 1:nSub) {
  ...
  savefile=paste("Modelling/dataset3-SOA2/07_Outputs/P",useSub,"_z_Model.Rdata",sep="")
...
for(useSub in 1:nSub) {
  ...
  load(paste("Modelling/dataset3-SOA2/07_Outputs/P",useSub,"_z_Model.Rdata",sep="")) #Loads through the datasets of each participant in nSub
  ...
  save(sim, file = paste("Data/dataset3-SOA2/Model-Predictions/P",useSub,"_z.Rdata", sep = ""))
