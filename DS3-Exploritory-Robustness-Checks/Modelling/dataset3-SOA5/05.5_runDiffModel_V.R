...
for (useSub in 1:nSub) {
  ...
  savefile=paste("Modelling/dataset3-SOA5/07_Outputs/P",useSub,"_v_Model.Rdata",sep="")
...
for(useSub in 1:nSub) {
  ...
  load(paste("Modelling/dataset3-SOA5/07_Outputs/P",useSub,"_v_Model.Rdata", sep = "")) #Loads through the datasets of each participant in nSub
  ...
  save(sim, file = paste("Data/dataset3-SOA5/Model-Predictions/P",useSub,"_v.Rdata", sep = ""))
