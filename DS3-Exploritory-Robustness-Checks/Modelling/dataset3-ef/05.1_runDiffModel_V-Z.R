...
setwd(here())
source("Modelling/dataset3-ef/02_megaBackground.R")
...
for (useSub in 1:nSub) {
  load(paste("Data/dataset3-ef/clean/P",useSub,".Rdata",sep=""))
  ...
  savefile=paste("Modelling/dataset3-ef/07_Outputs/P",useSub,"_v-z_Model.Rdata",sep="")
  
  source("Modelling/dataset3-ef/03_background.R")
  source("Modelling/dataset3-ef/04_runIterativeProcess.R")
...
for(useSub in 1:nSub) {
  ...
  load(paste("Modelling/dataset3-ef/07_Outputs/P",useSub,"_v-z_Model.Rdata", sep = "")) #Loads through the datasets of each participant in nSub
  ...
  save(sim, file = paste("Data/dataset3-ef/Model-Predictions/P",useSub,"_v-z.Rdata", sep = ""))
